...
const testimonials = [
    ...
    {
        feedback: "Moving to Sri Lanka, I was worried about finding good quality produce. This website has been my savior! Their English interface is easy to navigate, and the variety of fruits I'd never tried before—like wood apple and soursop—came with helpful preparation tips. The customer service team is incredibly responsive and friendly.",
        place: 'Ravi phillins',
        name: "John Doe",
    ...
    return (
        <div className="testimonial-wrapper">
            ...
            <div className="carosal">
                ...
                <Carousel className="carosal-inner"  dotPosition="bottom" slidesToShow={2.5} dots={false}>
