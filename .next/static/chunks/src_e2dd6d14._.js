...
"[project]/src/Globals/Localstorage.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function setUser(data) {
    ...
    if ("TURBOPACK compile-time truthy", 1) localStorage.setItem("user", JSON.stringify(data));
}
function getUser() {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Globals$2f$Localstorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/Globals/Localstorage.ts [app-client] (ecmascript)");
...
const CardComponent = (props)=>{
    ...
    const { addtocartLoad, addtocartData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])({
        "CardComponent.useSelector": (state)=>state.bcl
    }["CardComponent.useSelector"]);
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Globals$2f$Localstorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUser"])();
...
_s(CardComponent, "PNaL5xAPN/YWrXcahmw5HQeLPn8=", false, function() {
    return [
...
//# sourceMappingURL=src_e2dd6d14._.js.map